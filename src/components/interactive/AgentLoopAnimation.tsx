...
const boxPositions = [
  { id: "user", label: "用户", x: 50, y: 20, color: "bg-blue-100 border-blue-300 text-blue-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
  { id: "llm", label: "LLM", x: 200, y: 20, color: "bg-purple-100 border-purple-300 text-purple-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
  { id: "tool-call", label: "工具调用", x: 350, y: 20, color: "bg-indigo-100 border-indigo-300 text-indigo-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
  { id: "permission", label: "权限检查", x: 350, y: 100, color: "bg-red-100 border-red-300 text-red-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
  { id: "execute", label: "执行工具", x: 200, y: 100, color: "bg-emerald-100 border-emerald-300 text-emerald-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
  { id: "result", label: "返回结果", x: 50, y: 100, color: "bg-amber-100 border-amber-300 text-amber-700 dark:bg-zinc-900 dark:border-zinc-500 dark:text-zinc-100" },
];
    ...
    <div className="my-6 bg-card rounded-xl border border-border p-5">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          className="px-4 py-2 text-sm rounded-lg border border-border text-muted-foreground hover:bg-muted hover:text-foreground disabled:opacity-30 disabled:cursor-not-allowed"
        >
          ← 上一步
        </button>
        ...
        <button
          ...
          className="px-4 py-2 text-sm rounded-lg bg-primary text-primary-foreground hover:bg-primary/80 disabled:opacity-30 disabled:cursor-not-allowed"
        >
          下一步 →
        </button>
      </div>
